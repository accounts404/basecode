...
export default function HorarioCalendario({ 
    ...
    // CORREGIDO: Función para filtrar eventos por día LOCAL del usuario
    // Convierte la fecha UTC del evento a fecha local para comparar correctamente
    const getEventsForDay = (dayDate) => {
        ...
        const filtered = eventsToDisplay.filter(event => {
            ...
            // CRÍTICO: Convertir la fecha UTC del evento a fecha LOCAL del usuario
            // Crear un objeto Date desde el ISO string (JavaScript lo interpreta como UTC)
            const eventStartDate = new Date(event.start_time);
            
            // Extraer la fecha en zona horaria LOCAL del usuario
            ...
            return eventLocalDateString === columnDateString;
        });
