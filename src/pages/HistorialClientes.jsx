                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <div className="font-medium">
                                    {format(parseISO(service.start_time), 'dd MMM yyyy', { locale: es })}
                                </div>
                                <div className="text-sm text-slate-500">
                                    {format(parseISO(service.start_time), 'HH:mm', { locale: es })} - {format(parseISO(service.end_time), 'HH:mm', { locale: es })}
                                </div>
                            </div>
                        </div>
                    </TableCell>
                                                        ...
                                                        <div key={idx} className="flex items-center justify-between bg-white p-2 rounded border">
                                                            ...
                                                            <span className="text-sm text-slate-600">
                                                                {cs.start_time && cs.end_time ? 
                                                                    `${format(parseISO(cs.start_time), 'HH:mm')} - ${format(parseISO(cs.end_time), 'HH:mm')}` 
                                                                    : 'Horario no definido'}
                                                            </span>
                                                        </div>
                                                    );
